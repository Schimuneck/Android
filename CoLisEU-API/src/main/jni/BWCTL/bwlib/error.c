        ...
        )
{
    ...
    //__android_log_print(ANDROID_LOG_DEBUG, "JNI_DEBUG", "Ta aqui\n");

    //__android_log_print(ANDROID_LOG_DEBUG, "JNI_DEBUG", fmt, ap);
    ...
    if(ctx && ctx->eh){
        ...
        __android_log_print(ANDROID_LOG_DEBUG, "JNI_ERRO_LOG", "%s\n", buff);
    }
    va_end(ap);
